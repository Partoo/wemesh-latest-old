    ...
    public static function get($key)
    {
        $list = [
            ...
            'upload' => [
                ...
                'imagePathFormat' => '/uploads/image/post/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
                ...
                'scrawlPathFormat' => '/uploads/image/scraw/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
                ...
                'snapscreenPathFormat' => '/uploads/image/snap/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
                ...
                'catcherPathFormat' => '/uploads/image/catch/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
                ...
                'videoPathFormat' => '/uploads/video/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
                ...
                'filePathFormat' => '/uploads/file/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
