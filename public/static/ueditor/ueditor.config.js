...
(function () {
  ...
  window.UEDITOR_CONFIG = {
    ...
    serverUrl: 'http://wemesh.dev/api/ueditor/server',

    // 工具栏上的所有的功能按钮和下拉框，可以在new编辑器的实例时选择自己需要的重新定义
    toolbars: [[
      'source', 'fullscreen', 'undo', 'redo', 'fontsize', 'blockquote', 'horizontal', 'removeformat', 'formatmatch', 'link', 'unlink',
    ...
    initialFrameWidth:"auto",  //初始化编辑器宽度,默认1000, 改成auto会自动适应窗口改变 by Partoo
